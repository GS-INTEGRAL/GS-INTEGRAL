...
class ResPartner(models.Model):
    ...
    def _update_obra_ids(self):
        if self.obra_id == "maristas":
            self._fields["obra_ids"].selection = [
                ("fuensanta", "Fuensanta"),
                ("merced", "Merced"),
            ]
        else:
    ...
    def _update_estancias_id(self):
        if self.obra_ids == "fuensanta":
            self._fields["estancias_id"].selection = [
